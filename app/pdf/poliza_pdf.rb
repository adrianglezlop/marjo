class PolizaPdf < Prawn::Document
  ...
  def text_content
    ...
    draw_text  "FIRMA BENEFICIO DE DESARROLLO SOCIAL RECIBIDO ",:size=>8, :at => [300,570+des]
    ...
    draw_text  "PROMOTOR DE BENEFICIO DE DESARROLLO SOCIAL:  #{@credit.padre.nombre_completo}  ",:size=> 9, :at => [270,520+des]
