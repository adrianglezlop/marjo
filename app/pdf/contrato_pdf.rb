class ContratoPdf < Prawn::Document
  ...
  def text_content
   ...
   text " "
    ...
    text "Como garantía de cumplimiento, junto con la firma del presente convenio, 'El Beneficiario' firmará un Título de Apoyo Económico(Pagaré) por el monto total del apoyo, así como por el monto de las cantidades adicionales para la recomposición del Fondo Revolvente.",:size =>10,:align => :justify 
