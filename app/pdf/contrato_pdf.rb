class ContratoPdf < Prawn::Document
  ...
  def text_content
   ...
   text "CONVENIO DE COLABORACIÓN PARA EL OTORGAMIENTO DE UN APOYO ECONÓMICO SOCIAL" , :align  => :center, :style=> :bold
    ...
    text "I.- La Fundación ___________________________, es una Organización de la Sociedad Civil que tiene como objeto el realizar las siguientes actividades de Fomento: " , :align  => :justify, :style=> :bold
    text "1) Cívicas, enfocadas a promover la participación ciudadana en asuntos de interés público." , :align  => :justify, :style=> :bold
    text "2) Fomento de acciones para mejorar la economía popular." , :align  => :justify, :style=> :bold
    text "3) Prestación de servicios de apoyo a la creación y fortalecimiento d organizaciones que realicen actividades objeto de fomento." , :align  => :justify, :style=> :bold
    text "4) La realización de actividades de asistencia social que tengan como beneficiarios a personas, sectores y regiones de escasos recursos; que realicen actividades para lograr mejores condiciones d subsistencia y desarrollo a las comunidades indígenas y a los grupos vulnerables por edad, sexo o problemas de discapacidad, dedicadas, entre otras a: la atención a requerimientos básicos de subsistencia en materia de alimentaciín, vestido o vivienda; Orientación social , educación o capacitación para el trabajo; Aportación de servicios para la atención a grupos sociales con discapacidad; Fomento de acciones para mejorar la economía popular, entre otros. " , :align  => :justify, :style=> :bold
    text "II.- 'La Fundación' tiene la prohibición expresa de otorgar los apoyos materia de este convenio a sus integrantes o a sus parientes colaterales hasta el cuarto grado, situación que, se manifiesta, no se da en la presente colaboración." , :align  => :justify, :style=> :bold
    text "III.- 'El Beneficiario' comprende la importancia de la presente colaboración y se compromete a regresar el importe d las cantidades otorgadas, y los montos adicionales convenidos, consciente de que es la manera de seguir beneficiando a más personas y con la oportunidad recibida por este apoyo, sabiendo que no es una entrega económica a fondo perdido y que con su puntual cumplimiento en los montos y fechas límite de retorno del beneficio recibido, 'La Fundación' podrá seguir desarrollando sus objetivos sociales de ayuda y apoyo a diversos sectores de la población, todos ellos autorizados por la Secretaría de Hacienda y Crédito Público, a través del Servicio de Administración Tributaria." , :align  => :justify, :style=> :bold
