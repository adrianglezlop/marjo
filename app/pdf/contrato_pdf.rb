class ContratoPdf < Prawn::Document
  ...
  def text_content
   ...
   text " "
    ...
    text "II.- 'La Fundación' tiene la prohibición expresa de otorgar los apoyos materia de este convenio a sus integrantes o a sus parientes colaterales hasta el cuarto grado, situación que, se manifiesta, no se da en la presente colaboración." , :size =>10, :align  => :justify
    text "III.- 'El Beneficiario' comprende la importancia de la presente colaboración y se compromete a regresar el importe de las cantidades otorgadas y los montos adicionales convenidos, consciente de que es la manera de seguir beneficiando a más personas y con la oportunidad recibida por este apoyo, sabiendo que no es una entrega económica a fondo perdido y que con su puntual cumplimiento en los montos y fechas límite de retorno del apoyo recibido, 'La Fundación' podrá seguir desarrollando sus objetivos sociales de ayuda y apoyo a diversos sectores de la población, todos ellos autorizados por la Secretaría de Hacienda y Crédito Público, a través del Servicio de Administración Tributaria." , :size =>10, :align  => :justify
    text " " 
    text "CLAUSULAS" ,:size =>10, :align  => :center
    text "PRIMERA: 'La Fundación' ha convenido en otorgar un Apoyo de Desarrollo Social a 'El Beneficiario' y este se compromete a reponer el monto total del importe recibido y las cantidades adicionales que servirán para la composición del Fondo Revolvente de 'La Fundación'. ",:size =>10,:align => :justify
    text "Como garantía de cumplimiento, junto con la firma del presente convenio, 'El Beneficiario' firmará un Título de Apoyo de Desarrollo Social(Pagaré) por el monto total del apoyo, así como por el monto de las cantidades adicionales para la recomposición del Fondo Revolvente.",:size =>10,:align => :justify 
    text "SEGUNDA: El importe que acepta y se obliga a pagar 'El Beneficiario', será el estipulado en RECIBO expedido por 'La Fundación' y las fechas de pago, serán las estipuladas en este convenio de colaboración, dicho recibo será firmado por 'El Beneficiario' o por las personas por él autorizadas y solidarias responsables de la recepción y pago de dicho Apoyo de Desarrollo Social. ",:size =>10,:align => :justify 
    ...
    text "
 APOYO DE DESARROLLO SOCIAL   ABONO (#{@credit.product.payout.periocidad})" , :align  => :center,:size =>10       
    ...
    * El tabulador que se despliega en el presente punto hace referencia a que el abono está condicionado a que por cada $1,000.00 de beneficio a 'El Beneficiario', deberá darse un abono por la cantidad de #{Dinero.to_money((1000*(1+@credit.product.taza_de_interes_ordinaria/100))/@credit.product.numero_de_pagos_a_realizar)} #{@credit.product.payout.periocidad}. El beneficio que adquirirá el Fondo Revolvente de 'La Fundación' es del orden de #{'%.2f' % @credit.product.taza_de_interes_ordinaria} % #{@credit.product.plazo}.",:size =>10,:align => :justify 
    text" Los recibos surtidos a 'La Fundación' no deberán rebasar el Apoyo de Desarrollo Social establecido que es de $ #{Dinero.to_money(@credit.monto_solicitud)}.",:size =>10,:align => :justify 
    text" 'La Fundación' tiene en todo momento el derecho de negar cualquier pedido a 'El Beneficiario' cuando algún recibo se encuentre con más de 1 día de atraso, independientemente de que su Apoyo de Desarrollo Social sea menor de $ #{Dinero.to_money(@credit.monto_solicitud)} " ,:size =>10,:align => :justify 
    ...
    text" El Apoyo de Desarrollo Social otorgado jamás podrá exceder a la cantidad que resulte de dos meses de ingreso propio que 'El Beneficiario' demuestre para la firma del presente convenio de colaboración de Apoyo de Desarrollo Social.",:size =>10,:align => :justify 
    text" CUARTA: A falta de pago puntual de cualquier recibo emitido por 'La Fundación' de conformidad con las segunda y tercera cláusulas del Convenio de Colaboración, se dará por vencido este convenio, y en consecuencia se suspenderá el Apoyo de Desarrollo Social ofrecido, debiendo 'La Fundación' exigir a 'El Beneficiario' lo siguiente:",:size =>10,:align => :justify 
    ...
    text" QUINTA: 'El Beneficiario' o sus apoderados legales, al firmar el recibo de recepción del Apoyo de Desarrollo Social, hacen constar que recibieron el mismo a su entera satisfacción.",:size =>10,:align => :justify 
   ...
   text " "
    text "En la ciudad de #{@credit.padre.municipio}, a #{@credit.fecha_en_español} comparecieron para celebrar el presente convenio de colaboración para el otorgamiento de un Apoyo de Desarrollo Social, por una parte el(la) Sr(a). #{Conf.last.representante_legal}, representante legal de FUNDACION VALOR A.C., con domicilio en: #{Conf.last.domicilio} en la ciudad de CULIACAN, SIN. a quien en lo sucesivo se le denominará 'La Fundación', y por otra parte el(la) Sr(a). #{@credit.nombre_completo_deudor} con domicilio en #{@credit.domicilio } a quien en lo sucesivo se le denominará 'El Beneficiario', al tenor de los siguientes antecedentes y claúsulas:",:size =>10,:align => :justify 
    text " "    
    text "I.- FUNDACION VALOR A.C. es una Organización de la Sociedad Civil que tiene como objeto el realizar las siguientes actividades de Fomento: " ,:size =>10, :align  => :justify
    text "1) Cívicas, enfocadas a promover la participación ciudadana en asuntos de interés público." , :size =>10, :align  => :justify
    text "2) Fomento de acciones para mejorar la economía popular." , :size =>10, :align  => :justify
    text "3) Prestación de servicios de apoyo a la creación y fortalecimiento de organizaciones que realicen actividades objeto de fomento." , :size =>10, :align  => :justify
    text "4) La realización de actividades de asistencia social que tengan como beneficiarios a personas, sectores y regiones de escasos recursos; que realicen actividades para lograr mejores condiciones de subsistencia y desarrollo a las comunidades indígenas y a los grupos vulnerables por edad, sexo o problemas de discapacidad, dedicadas, entre otras a: la atención a requerimientos básicos de subsistencia en materia de alimentación, vestido o vivienda; Orientación social, educación o capacitación para el trabajo; Aportación de servicios para la atención a grupos sociales con discapacidad; Fomento de acciones para mejorar la economía popular, entre otros. " , :size =>10, :align  => :justify
